...
public class GlobalConstants {
	public static final String APP_VERSION_NAME = "LCD Display V1.0.0.15 Sep.19/2016";
	public static final char HORIZONTAL_SIGN = '-';
	public static final char VERTICAL_SIGN = '|';
}
